...
def show():
    ...
    with col_center:
        ...
        if is_defense: st.markdown('<div style="text-align:center;color:#888;font-size:12px;margin-bottom:10px;">📉 0..Freq → Action | 📈 Freq..100 → Fold</div>', unsafe_allow_html=True)
